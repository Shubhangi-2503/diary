...
{
    /// <inheritdoc />
    public partial class GetDiaryEntriesSP : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(@"
-- Remove USE, GO, and SET commands. Only keep the SP logic.
USE [DiaryDB]
GO
...
*************************************************************************************************/
CREATE OR ALTER PROCEDURE [dbo].[sp_GetDiaryEntries]
    @Id INT = NULL  -- Optional parameter
AS
BEGIN
    SET NOCOUNT ON;
    SELECT Id, Title, Content, Createdon, CreatedById
    FROM DiaryEntries
