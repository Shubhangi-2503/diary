...
{
    /// <inheritdoc />
    public partial class alter_creatediaryentrySP : Migration
    {
        /// <inheritdoc />
...
*************************************************************************************************/
ALTER PROCEDURE sp_CreateDiaryEntry 
...
BEGIN
	...
	SET @Status = 'S'; -- 'S' for Success
    SET @Message = 'Entry created successfully.';
	END TRY
	BEGIN CATCH
		SELECT 
			...
			ERROR_MESSAGE() AS ErrorMessage;
			 SET @Status = 'E'; -- 'E' for Error
        SET @Message = ERROR_MESSAGE(); -- Capture the actual SQL error
	END CATCH
END
GO
");
